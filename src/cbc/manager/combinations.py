...
def get_list_of_combinations():
    ...
    combinations['tmp4'] = Combination(['cbc2pia', 'embed2', 'cheat'],
                        ['fov135-pow3_sat', 'fov225-pow3_sat',
                         'fov270-pow3_sat']
                        + ['fov45-pow3_sat', 'fov90-pow3_sat'])

    combinations['tmp5'] = Combination(['cbc1pi', 'cbc2pi', 'cbc1pia',
                                         'cbc2pia',
                                        'embed2', 'cheat'],
                                       ['fov45-pow3_sat',
                                        'fov90-pow3_sat',
    ...
    for t in ['noisy', 'zero']:
        combinations['paper-obs2d-%s' % t] = Combination(paper_algos2d,
                                                    addpost(observable2d, t))
        ob3 = addpost(observable3d, t)
        if t == 'noisy':
            ob3.append('fly')
        combinations['paper-obs3d-%s' % t] = Combination(paper_algos3d, ob3)
        combinations['paper-unobs2d-%s' % t] = Combination(paper_algos2d,
                                                 addpost(unobservable2d, t))
    ...
    combinations['warp'] = Combination(
                    ['cheat', 'embed3', 'CBC3d', 'CBC3dr50',
                     'CBC3dw', 'CBC3dr50w'],
            ['rand-3D-fov45-linear01-zero',
                                        'rand-3D-fov45-pow7_sat-zero'])

    combinations['mino2d'] = Combination(['embed2', 'CBC2d', 'CBC2dw',
                                           'CBC2dr50w', 'cheat'],
                                       ['mino4_center*',
                                        'mino4_middle*'])

    combinations['old_nips_mino3d'] = Combination(['embed3', 'CBC3d',
                                            'CBC3dw', 'CBC3dr50w', 'cheat'],
                                       ['mino4_grid24-*',
                                        'mino4_grid24art-*'])

    combinations['old_nips_fly'] = Combination(['embed3', 'CBC3d', 'CBC3dw',
                                                'CBC3dr50w', 'cheat'],
                                       ['fly'])
    ...
    combinations['mino3d_all'] = Combination(['embed3', 'CBC3d', 'CBC3dw',
                                              'CBC3dr50w', 'cheat'],
                                       ['mino4_grid24-*',
                                        'mino4_patch32-*',
                                        'mino4_patch32s4-*',
    ...
    combinations['mino3dart'] = Combination(['embed3', 'CBC3d', 'CBC3dw',
                                             'CBC3dr50w', 'cheat'],
                                       ['mino4_grid24art-*',
                                        'mino4_patch32art-*',
                                        'mino4_patch32s4art-*',
...
#    
    combinations['nips_spherical_sim_2d_obs'] = Combination(nips_spherical2d_w,
                                                            observable2d)
    combinations['nips_spherical_sim_2d_unobs'] = \
        Combination(nips_spherical2d,
                    unobservable2d +
                    ['sick_front-y_corr',
...
#    
    combinations['pami_spherical_sim_2d_obs'] = \
        Combination(pami_algo_spherical2d_w, pami_tc_observable2d)
    combinations['pami_spherical_sim_2d_unobs'] = \
        Combination(pami_algo_spherical2d,
