...
@k
def eu_linear01_sat(d):
    return saturate(eu_linear01, d)
...
def generate_grid_euclidean_test_case(tcid, num, ndim, kernel,
                                      wiggle_noise, dist_noise):
    assert ndim == 2
    ...
    def wiggle():
        return np.random.randn() * wiggle_noise
